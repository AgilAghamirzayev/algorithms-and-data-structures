...
```
cd existing_repo
git remote add origin https://gitlab.com/Aqilzeka/algorithms-and-data-structures.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Aqilzeka/algorithms-and-data-structures/-/settings/integrations)
